<template>
  <main class="l-page" :data-page="pageType">
    ...
    <div class="cfoot is-fixed column">
      <button type="button" class="c-btn squared">
        <span class="text">버튼</span>
      </button>
      <button type="button" class="c-btn c-link squared white">
        <span class="text">링크</span>
      </button>
    </div>
  </main>
</template>
...
onMounted(() => {
  ...
  setHeaderOptions({
    ...
    isCenterTitle: true,      // 타이틀 가운데 정렬 여부
  });
});
