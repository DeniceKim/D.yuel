      ...
      <section>
        ...
        <div class="code_editor">
          ...
          <div class="code_input">
            ...
            <div class="c-step">
              <ol class="c-step-inner">
                <li class="c-step-item">
                  <div class="c-step-text">대기</div>
                </li>
                <li class="c-step-item">
                  <div class="c-step-text">대기</div>
                </li>
            ...
            <div class="c-step">
              <ol class="c-step-inner">
                <li class="c-step-item">
                  <div class="c-step-text">완료</div>
                </li>
                <li class="c-step-item" aria-current="step">
                  <div class="c-step-text">진행중</div>
                </li>
                <li class="c-step-item">
                  <div class="c-step-text">대기</div>
                </li>
...
<style lang="scss">
@use "@/assets/scss/component/_step" as step;
</style>